...
while True: 
	...
	# if mouse is hovered on a button it changes to lighter shade 
	if width-800 <= mouse[0] <= width-550 and height-370 <= mouse[1] <= height-220: 
		pygame.draw.rect(screen,color_dark,[width-800,height-370,250,150]) 
		
	else: 
		pygame.draw.rect(screen,color_black,[width-800,height-370,250,150]) 
	# if mouse is hovered on a button it changes to lighter shade 
	if width-550 <= mouse[0] <= width-300 and height-370 <= mouse[1] <= height-220: 
		pygame.draw.rect(screen,color_dark,[width-550,height-370,250,150]) 
		
	else: 
		pygame.draw.rect(screen,color_black,[width-550,height-370,250,150]) 

		
	# superimposing the text onto our button 
	screen.blit(audio_gain , (width-735,height-470))
	screen.blit(assist_tools , (width-490,height-470))
	screen.blit(false_color , (width-490,height-420)) 
	screen.blit(shutter , (width-700,height-350)) 
	screen.blit(iso , (width-450,height-350)) 
